...
import ChevronDownIcon from "../assets/icons/chevron-left.svg";
import HorizontaLDots from "../assets/icons/horizontal-dots.svg";
import GridIcon from "../assets/icons/grid.svg";
import ListIcon from "../assets/icons/list.svg";
import PageIcon from "../assets/icons/page.svg";
import CalenderIcon from "../assets/icons/calendar.svg?url";
import TableIcon from "../assets/icons/table.svg";
import BoxCubeIcon from "../assets/icons/box.svg";
          ...
          {nav.subItems ? (
            ...
            >
              <span className={`menu-item-icon-size  ${ openSubmenu?.type === menuType && openSubmenu?.index === index ? "menu-item-icon-active" : "menu-item-icon-inactive" }`} >
               <img src={nav.icon} className="dark:text-white" alt={nav.name}  />
              </span>
          ...
          <div className="flex flex-col gap-4">
            <div>
              <h2 className={`mb-4 text-xs uppercase text-gray-400 ${!isExpanded && !isHovered ? "lg:justify-center" : "justify-start"}`}>
                {isExpanded || isHovered || isMobileOpen ? "Menu" : <img src={HorizontaLDots} className="size-6" />}
              </h2>
              {renderMenuItems(navItems, "main")}
            </div>
            <div>
              <h2 className={`mb-4 text-xs uppercase text-gray-400 ${!isExpanded && !isHovered ? "lg:justify-center" : "justify-start"}`}>
                {isExpanded || isHovered || isMobileOpen ? "Others" : <img src={HorizontaLDots} />}
              </h2>
